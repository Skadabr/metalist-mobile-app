...
export class ScannerComponent implements OnInit {
    ...
    constructor(private router: Router,
        ...
        this.sectorsInVip = ['VIP', 'VIP_BR', 'VIP_BL', 'VIP_AR', 'VIP_AL', 'SB_1', 'SB_7'];
    }
    ...
    checkTicketOffline(code) {
        ...
        //console.log('ticket123', ticket.tribune, ticket.status);
        if ( !ticket ) {
    ...
    getCountTicketsOffline(tickets, tribune) {
        if ( tribune === 'vip' ) {
            ...
            this.count = tickets.filter( ticket => (ticket.status === 'paid' && ticket.tribune === tribune) ).length;
        }
    }
